...
public class SearchTraineeCommand implements AjaxActionCommand {
	...
	public String execute(HttpServletRequest request,
		...
		if(chooseBy != null && !chooseBy.equals("")){
			List<Trainee> list_of_trainee = TraineeService.searchTrainee(chooseBy);
